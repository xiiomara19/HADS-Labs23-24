...
<body style="height: 121px">
    <form id="form1" runat="server">
        ...
        <asp:Panel ID="Panel2" runat="server" Height="254px" Width="1164px">
            ...
            <br />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="sqldsDocentesGrupos" AutoPostBack="True" DataTextField="irakasgaiKodea"  DataValueField="irakasgaiKodea">
