...
function Board() {
  const {enteredLetter} = useContext(AppContext);
            ...
            <div className="game_boards">
              <div className="game_boards-row">
                <div className="row_field">
                  ...
                  <div id='T1R2' className={`Row ${visitedRows.includes(1) ? 'Row-current' : ''}`}>
                  ...
                  <div id='T1R23' className={`Row ${visitedRows.includes(2) ? 'Row-current' : ''}`}>
                  ...
                  <div id='T1R4' className={`Row ${visitedRows.includes(3) ? 'Row-current' : ''}`}>
                  ...
                  <div id='T1R5' className={`Row ${visitedRows.includes(4) ? 'Row-current' : ''}`}>
                  ...
                  <div id='T1R6' className={`Row ${visitedRows.includes(5) ? 'Row-current' : ''}`}>
                  ...
                  <div id='T1R7' className={`Row ${visitedRows.includes(6) ? 'Row-current' : ''}`}>
                  ...
                  <div id='T1R8' className={`Row ${visitedRows.includes(7) ? 'Row-current' : ''}`}>
                  ...
                  <div id='T1R9' className={`Row ${visitedRows.includes(8) ? 'Row-current' : ''}`}>
                ...
                <div id='T2R1' className="Row Row-current">
                  ...
                  <div id='T2R2' className={`Row ${visitedRows.includes(1) ? 'Row-current' : ''}`}>
                  ...
                  <div id='T2R3' className={`Row ${visitedRows.includes(2) ? 'Row-current' : ''}`}>
                  ...
                  <div id='T2R4' className={`Row ${visitedRows.includes(3) ? 'Row-current' : ''}`}>
                  ...
                  <div id='T2R5' className={`Row ${visitedRows.includes(4) ? 'Row-current' : ''}`}>
                  ...
                  <div id='T2R6' className={`Row ${visitedRows.includes(5) ? 'Row-current' : ''}`}>
                  ...
                  <div id='T2R7' className={`Row ${visitedRows.includes(6) ? 'Row-current' : ''}`}>
                  ...
                  <div id='T2R8' className={`Row ${visitedRows.includes(7) ? 'Row-current' : ''}`}>
                  ...
                  <div id='T2R9' className={`Row ${visitedRows.includes(8) ? 'Row-current' : ''}`}>
              ...
              <div className="game_boards-row">
                <div className="row_field">
                  ...
                  <div id='T3R2' className={`Row ${visitedRows.includes(10) ? 'Row-current' : ''}`}>
                  ...
                  <div id='T3R3' className={`Row ${visitedRows.includes(11) ? 'Row-current' : ''}`}>
                  ...
                  <div id='T3R4' className={`Row ${visitedRows.includes(12) ? 'Row-current' : ''}`}>
                  ...
                  <div id='T3R5' className={`Row ${visitedRows.includes(13) ? 'Row-current' : ''}`}>
                  ...
                  <div id='T3R6' className={`Row ${visitedRows.includes(14) ? 'Row-current' : ''}`}>
                  ...
                  <div id='T3R7' className={`Row ${visitedRows.includes(15) ? 'Row-current' : ''}`}>
                  ...
                  <div id='T3R8' className={`Row ${visitedRows.includes(16) ? 'Row-current' : ''}`}>
                ...
                <div className="row_field">
                  ...
                  <div id='T4R2' className={`Row ${visitedRows.includes(10) ? 'Row-current' : ''}`}>
                  ...
                  <div id='T4R3' className={`Row ${visitedRows.includes(11) ? 'Row-current' : ''}`}>
                  ...
                  <div id='T4R4' className={`Row ${visitedRows.includes(12) ? 'Row-current' : ''}`}>
                  ...
                  <div id='T4R5' className={`Row ${visitedRows.includes(13) ? 'Row-current' : ''}`}>
                  ...
                  <div id='T4R6' className={`Row ${visitedRows.includes(14) ? 'Row-current' : ''}`}>
                  ...
                  <div id='T4R7' className={`Row ${visitedRows.includes(15) ? 'Row-current' : ''}`}>
                  ...
                  <div id='T4R8'className={`Row ${visitedRows.includes(16) ? 'Row-current' : ''}`}>
                  ...
                  <div id='T4R9'className={`Row ${visitedRows.includes(17) ? 'Row-current' : ''}`}>
