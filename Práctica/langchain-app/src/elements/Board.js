            ...
            <div className="game_boards">
              ...
              <div className="game_boards-row">
                <div className="row_field">
                  ...
                  <div id='T3R2' className={`Row ${enteredLetter.row ==1 ? 'Row-current' : ''}`}>
                  ...
                  <div id='T3R3' className={`Row ${enteredLetter.row ==2 ? 'Row-current' : ''}`}>
                  ...
                  <div id='T3R4' className={`Row ${enteredLetter.row ==3 ? 'Row-current' : ''}`}>
                  ...
                  <div id='T3R5' className={`Row ${enteredLetter.row ==4 ? 'Row-current' : ''}`}>
                  ...
                  <div id='T3R6' className={`Row ${enteredLetter.row ==5 ? 'Row-current' : ''}`}>
                  ...
                  <div id='T3R7' className={`Row ${enteredLetter.row ==6 ? 'Row-current' : ''}`}>
                  ...
                  <div id='T3R8' className={`Row ${enteredLetter.row ==7 ? 'Row-current' : ''}`}>
                  ...
                  <div id='T3R9' className={`Row ${enteredLetter.row ==8 ? 'Row-current' : ''}`}>
                ...
                <div className="row_field">
                  ...
                  <div id='T4R2' className={`Row ${enteredLetter.row ==1 ? 'Row-current' : ''}`}>
                  ...
                  <div id='T4R3' className={`Row ${enteredLetter.row ==2 ? 'Row-current' : ''}`}>
                  ...
                  <div id='T4R4' className={`Row ${enteredLetter.row ==3 ? 'Row-current' : ''}`}>
                  ...
                  <div id='T4R5' className={`Row ${enteredLetter.row ==4 ? 'Row-current' : ''}`}>
                  ...
                  <div id='T4R6' className={`Row ${enteredLetter.row ==5 ? 'Row-current' : ''}`}>
                  ...
                  <div id='T4R7' className={`Row ${enteredLetter.row ==6 ? 'Row-current' : ''}`}>
                  ...
                  <div id='T4R8'className={`Row ${enteredLetter.row ==7 ? 'Row-current' : ''}`}>
                  ...
                  <div id='T4R9'className={`Row ${enteredLetter.row ==8 ? 'Row-current' : ''}`}>
