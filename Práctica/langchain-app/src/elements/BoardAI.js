...
function BoardAI() {
  const {enteredLetterAI, guessedRowsAI} = useContext(AppContext);
            ...
            <div className="game_boards">
              <div className="game_boards-row">
                <div className="row_field">
                  <div id='T1R1' className={`Row ${visitedRows.includes(1) ? '' : 'Row-current'} ${guessedRowsAI[0].row === 0 ? 'Row-current' : ''}`}>
                  ...
                  <div id='T1R2' className={`Row ${enteredLetterAI.row === 1 ? 'Row-current' : ''} ${guessedRowsAI[0].row === 1 ? 'Row-current' : ''}`}>
                  ...
                  <div id='T1R23' className={`Row ${enteredLetterAI.row === 2 ? 'Row-current' : ''} ${guessedRowsAI[0].row === 2 ? 'Row-current' : ''}`}>
                  ...
                  <div id='T1R4' className={`Row ${enteredLetterAI.row === 3 ? 'Row-current' : ''} ${guessedRowsAI[0].row === 3 ? 'Row-current' : ''}`}>
                  ...
                  <div id='T1R5' className={`Row ${enteredLetterAI.row === 4 ? 'Row-current' : ''} ${guessedRowsAI[0].row === 4 ? 'Row-current' : ''}`}>
                  ...
                  <div id='T1R6' className={`Row ${enteredLetterAI.row === 5 ? 'Row-current' : ''} ${guessedRowsAI[0].row === 5 ? 'Row-current' : ''}`}>
                  ...
                  <div id='T1R7' className={`Row ${enteredLetterAI.row === 6 ? 'Row-current' : ''} ${guessedRowsAI[0].row === 6 ? 'Row-current' : ''}`}>
                  ...
                  <div id='T1R8' className={`Row ${enteredLetterAI.row === 7 ? 'Row-current' : ''} ${guessedRowsAI[0].row === 7 ? 'Row-current' : ''}`}>
                  ...
                  <div id='T1R9' className={`Row ${enteredLetterAI.row === 8 ? 'Row-current' : ''} ${guessedRowsAI[0].row === 8 ? 'Row-current' : ''}`}>
                ...
                <div className="row_field">
                <div id='T2R1' className={`Row ${visitedRows.includes(1) ? '' : 'Row-current'} ${guessedRowsAI[1].row === 0 ? 'Row-current' : ''}`}>
                  ...
                  <div id='T2R2' className={`Row ${enteredLetterAI.row === 1 ? 'Row-current' : ''} ${guessedRowsAI[1].row === 1 ? 'Row-current' : ''}`}>
                  ...
                  <div id='T2R3' className={`Row ${enteredLetterAI.row === 2 ? 'Row-current' : ''} ${guessedRowsAI[1].row === 2 ? 'Row-current' : ''}`}>
                  ...
                  <div id='T2R4' className={`Row ${enteredLetterAI.row === 3 ? 'Row-current' : ''} ${guessedRowsAI[1].row === 3 ? 'Row-current' : ''}`}>
                  ...
                  <div id='T2R5' className={`Row ${enteredLetterAI.row === 4 ? 'Row-current' : ''} ${guessedRowsAI[1].row === 4 ? 'Row-current' : ''}`}>
                  ...
                  <div id='T2R6' className={`Row ${enteredLetterAI.row === 5 ? 'Row-current' : ''} ${guessedRowsAI[1].row === 5 ? 'Row-current' : ''}`}>
                  ...
                  <div id='T2R7' className={`Row ${enteredLetterAI.row === 6 ? 'Row-current' : ''} ${guessedRowsAI[1].row === 6 ? 'Row-current' : ''}`}>
                  ...
                  <div id='T2R8' className={`Row ${enteredLetterAI.row === 7 ? 'Row-current' : ''} ${guessedRowsAI[1].row === 7 ? 'Row-current' : ''}`}>
                  ...
                  <div id='T2R9' className={`Row ${enteredLetterAI.row === 8 ? 'Row-current' : ''} ${guessedRowsAI[1].row === 8 ? 'Row-current' : ''}`}>
              ...
              <div className="game_boards-row">
                <div className="row_field">
                  <div id='T3R1' className={`Row ${visitedRows.includes(1) ? '' : 'Row-current'} ${guessedRowsAI[2].row === 0 ? 'Row-current' : ''}`}>
                  ...
                  <div id='T3R2' className={`Row ${enteredLetterAI.row === 1 ? 'Row-current' : ''} ${guessedRowsAI[2].row === 1 ? 'Row-current' : ''}`}>
                  ...
                  <div id='T3R3' className={`Row ${enteredLetterAI.row === 2 ? 'Row-current' : ''} ${guessedRowsAI[2].row === 2 ? 'Row-current' : ''}`}>
                  ...
                  <div id='T3R4' className={`Row ${enteredLetterAI.row === 3 ? 'Row-current' : ''} ${guessedRowsAI[2].row === 3 ? 'Row-current' : ''}`}>
                  ...
                  <div id='T3R5' className={`Row ${enteredLetterAI.row === 4 ? 'Row-current' : ''} ${guessedRowsAI[2].row === 4 ? 'Row-current' : ''}`}>
                  ...
                  <div id='T3R6' className={`Row ${enteredLetterAI.row === 5 ? 'Row-current' : ''} ${guessedRowsAI[2].row === 5 ? 'Row-current' : ''}`}>
                  ...
                  <div id='T3R7' className={`Row ${enteredLetterAI.row === 6 ? 'Row-current' : ''} ${guessedRowsAI[2].row === 6 ? 'Row-current' : ''}`}>
                  ...
                  <div id='T3R8' className={`Row ${enteredLetterAI.row === 7 ? 'Row-current' : ''} ${guessedRowsAI[2].row === 7 ? 'Row-current' : ''}`}>
                  ...
                  <div id='T3R9' className={`Row ${enteredLetterAI.row === 8 ? 'Row-current' : ''} ${guessedRowsAI[2].row === 8 ? 'Row-current' : ''}`}>
                ...
                <div className="row_field">
                  <div id='T4R1' className={`Row ${visitedRows.includes(1) ? '' : 'Row-current'} ${guessedRowsAI[3].row === 0 ? 'Row-current' : ''}`}>
                  ...
                  <div id='T4R2' className={`Row ${enteredLetterAI.row === 1 ? 'Row-current' : ''} ${guessedRowsAI[3].row === 1 ? 'Row-current' : ''}`}>
                  ...
                  <div id='T4R3' className={`Row ${enteredLetterAI.row === 2 ? 'Row-current' : ''} ${guessedRowsAI[3].row === 2 ? 'Row-current' : ''}`}>
                  ...
                  <div id='T4R4' className={`Row ${enteredLetterAI.row === 3 ? 'Row-current' : ''} ${guessedRowsAI[3].row === 3 ? 'Row-current' : ''}`}>
                  ...
                  <div id='T4R5' className={`Row ${enteredLetterAI.row === 4 ? 'Row-current' : ''} ${guessedRowsAI[3].row === 4 ? 'Row-current' : ''}`}>
                  ...
                  <div id='T4R6' className={`Row ${enteredLetterAI.row === 5 ? 'Row-current' : ''} ${guessedRowsAI[3].row === 5 ? 'Row-current' : ''}`}>
                  ...
                  <div id='T4R7' className={`Row ${enteredLetterAI.row === 6 ? 'Row-current' : ''} ${guessedRowsAI[3].row === 6 ? 'Row-current' : ''}`}>
                  ...
                  <div id='T4R8'className={`Row ${enteredLetterAI.row === 7 ? 'Row-current' : ''} ${guessedRowsAI[3].row === 7 ? 'Row-current' : ''}`}>
                  ...
                  <div id='T4R9'className={`Row ${enteredLetterAI.row === 8 ? 'Row-current' : ''} ${guessedRowsAI[3].row === 8 ? 'Row-current' : ''}`}>
