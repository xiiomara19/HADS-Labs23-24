...
<body>
    <form id="form1" runat="server">
        ...
        <p>
            ...
            <asp:TextBox ID="PswdField1" runat="server" style="margin-bottom: 0px" TextMode="Password"></asp:TextBox>
        ...
        <asp:TextBox ID="PswdField2" runat="server" TextMode="Password"></asp:TextBox>
        ...
        <asp:Button ID="Button2" runat="server" Height="38px" Text="Volver" Width="110px" />
